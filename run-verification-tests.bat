...
if "%choice%"=="1" (
  call verify-fix1.bat
) else if "%choice%"=="2" (
  call verify-fix2.bat
) else if "%choice%"=="3" (
  call verify-fix3.bat
) else if "%choice%"=="q" (
  echo Exiting...
) else (
